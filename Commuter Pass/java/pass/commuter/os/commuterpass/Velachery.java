...
public class Velachery extends Activity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.velachery);
        spinner = (Spinner)findViewById(R.id.vspinner);
        radmonth=(RadioGroup)findViewById(R.id.vradioGroup);
        radcon=(RadioGroup)findViewById(R.id.vradioGroup1);
        radmonth.check(R.id.vamonth);
        radcon.check(R.id.vnon);
        ...
        categories.add("Fort");
        categories.add("Chintadripet");
        categories.add("Chepauk");
        categories.add("Thiruvallikeni");
        categories.add("Mandaveli");
        categories.add("Kotturpuram");
        categories.add("IndiraNagar");
        categories.add("Thiruvanmaiyur");
        categories.add("Perungudi");
        categories.add("Velachery");
        bpass=(Button)findViewById(R.id.vpass);
        ...
        spinner1 = (Spinner)findViewById(R.id.vspinner1);
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        else if(spinner.getId() == R.id.vspinner1)
        {
            String item = parent.getItemAtPosition(position).toString();
    ...
    public void onClick(View v) {
        if(sor==des)  Toast.makeText(this, "Souce-Destination cannot be the same", Toast.LENGTH_SHORT).show();
            ...
            String lol="";
            switch (vlo){
                case R.id.vnon: lol="None";concess=0; break;
                case R.id.vstud: lol="Student"; concess=4; break;
                case R.id.vwork: lol="Worker"; concess=2; break;
                case R.id.vsnr: lol="Senior Citizen"; concess=3; break;
            }
            fare=sor-des;
            concess*=.1;
            if(fare<0) fare*=-1;
